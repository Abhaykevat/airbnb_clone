...
import 'package:airbnb_clone/view/widgets/amenities_ui.dart';
...
class _CreatePostingScreenState extends State<CreatePostingScreen>
{
  ...
  _selectedImageFromGallery(int index) async
  {
                    ...
                    children: [
                      ...
                      Padding(padding: const EdgeInsets.only(top: 28.0),
                        child: DropdownButton(
                          ...
                          hint: const Text("selected property type",
                            style: TextStyle(
                              fontSize: 20
                            ),
                          ),
                      ...
                      Padding(padding: const EdgeInsets.only(top: 20.0),
                        child: Row(
                          ...
                          children:<Widget> [
                            ...
                            const Padding(padding: EdgeInsets.only(left:10.0,bottom: 10.0 ),
                      ...
                      const Padding(
                        ...
                        child: Text(
                          'Beds',style: TextStyle(
                            fontSize: 20.0,
                            fontWeight: FontWeight.bold,
                        ),
                        ),
                      ),
                      Padding(padding: const EdgeInsets.only(top: 21.0,left: 15.0,right: 15.0),
                        child: Column(
                          children: <Widget>[
                            //Twin/Single beds
                            AmenitiesUI(
                      ...
                      Padding(padding: const EdgeInsets.fromLTRB(15,25,15,0),
                        child: Column(
                          children: <Widget>[
                            //Full bathroom
                            AmenitiesUI(
                      ...
                      Padding(padding: EdgeInsets.only(top: 20.0,bottom: 25.0),
                        ...
                        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                          ...
                          itemBuilder: (context,index)
                          {
                            if(index==_imagelist!.length)
                            {
                              ...
                              {
                                _selectedImageFromGallery(-1);

                              }, icon:const Icon(Icons.add));

                            }
                            return MaterialButton(onPressed:(){},child: Image(image: _imagelist![index],fit:BoxFit.fill ,), );
                          },
                        ),
                      ),
